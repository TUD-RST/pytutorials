...
\Leftrightarrow \quad & u_1 = \frac{\dot{y}_{2,d} - k_{0,2}(y_2-y_{2,d})}{\sin{\left(\arctan\left(\frac{w_1}{\dot{y}_1}\right)\right)}} \\
\Leftrightarrow \quad & u_1 = \frac{\dot{y}_{2,d} - k_{0,2}(y_2-y_{2,d})}{\sin{\left(\arctan\left(\frac{\dot{y}_{2,d} - k_{0,2}(y_2-y_{2,d})}{\dot{y}_1}\right)\right)}} 
\end{align}
\end{subequations}
...
Then substitute $\mathbf{w}$ in \eqref{eq:5b} to solve for $u_2$:
\begin{subequations}
\begin{align}
