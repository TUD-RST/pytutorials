...
\lstinputlisting[numbers=left,firstnumber=28,firstline=28,lastline=41]{../sim/car-like_mobile_robot_plotting.py}
...
% def plot_data():
\lstinputlisting[numbers=left,firstnumber=42,firstline=42,lastline=89]{../sim/car-like_mobile_robot_plotting.py}
...
\lstinputlisting[numbers=left,firstnumber=112,firstline=112,lastline=115]{../sim/car-like_mobile_robot_plotting.py}
...
\lstinputlisting[numbers=left,firstnumber=122,firstline=122,lastline=180]{../sim/car-like_mobile_robot_animation.py}
...
\lstinputlisting[numbers=left,firstnumber=244,firstline=244,lastline=245]{../sim/car-like_mobile_robot_animation.py}
